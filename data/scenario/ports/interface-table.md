...
* ![](../../images/icons/toolbar-controls/edit_default.svg) **Configure**: open the dialog of editing of [field features](../../data/datasetfieldoptions.md). The dialog can be also opened by double clicking on the selected table row.
