...
* ![Дата/Время](./../../../images/icons/common/data-types/datetime_default.svg) *Дата/Время*;
* ![Число](./../../../images/icons/common/data-types/integer_default.svg) *Число*;
* ![Строка](./../../../images/icons/common/data-types/string_default.svg) *Строка*.

При преобразовании в тип данных ![Дата/Время](./../../../images/icons/common/data-types/datetime_default.svg) *Дата/Время* для ряда форматов имеется возможность выбрать начало и/или конец периода.
...
При выборе типа данных ![Тип данных](./../../../images/icons/common/data-types/string_default.svg) строка в выпадающем списке справа от ![Выбор](./../../../images/icons/common/toolbar-controls/down_default.svg) можно выбрать формат представления даты в строковом виде, а также задать [Свой формат](./syntax.md) при помощи строки форматирования.
